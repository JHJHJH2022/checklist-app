...
>
  <div class="flex w-full max-w-lg items-center justify-start">
    ...
    <input
      ...
      class="h-4 w-4 rounded border bg-cream-four text-green-four focus:border-green-five focus:outline focus:outline-2 focus:outline-offset-2 focus:outline-green-five"
    />
    ...
    />
    <span
      class="{completeClass} text-grady-five ml-5 hidden rounded-full py-0.5 px-2 text-sm font-normal md:block"
    >
